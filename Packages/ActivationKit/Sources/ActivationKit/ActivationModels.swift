...
public struct HotKeyConfiguration: Codable, Equatable, Sendable {
    ...
    public init(keyCode: UInt32 = 49, modifiers: UInt32 = 2_048 | 256, enabled: Bool = true) { self.keyCode = keyCode; self.modifiers = modifiers; self.enabled = enabled }
}
public enum ActivationPermissionStatus: String, Codable, Sendable { case notDetermined, denied, granted, restricted }
