...
| Microphone | Local double-clap feature extraction, guided calibration, and nonexecuting test | User enables, calibrates, or tests double-clap | Clap service remains paused; no retry occurs until permission is granted and the user resumes |
